...
forecast_data_deaths <- load_forecast_files_repo(file_paths = "submission/SigSci-TS/2021-02-15-SigSci-TS.csv",
...
forecast_data_cases <- load_forecast_files_repo(file_paths = "submission/SigSci-TS/2021-02-15-SigSci-TS.csv",
